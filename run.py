...
if __name__ == '__main__':
    ...
    # estimator
    parser.add_argument('--estimator', default='tvo', help='[vi, reinforce, vimco, gs, st-gs, tvo]')
    parser.add_argument('--mc', default=1, type=int, help='number of Monte-Carlo samples')
    parser.add_argument('--iw', default=5, type=int, help='number of Importance-Weighted samples')
    ...
    try:
        ...
        estimator = Estimator(baseline=baseline, mc=opt.mc, iw=opt.iw, N=opt.N, K=opt.K, hdim=opt.hdim, partition=opt.partition)
